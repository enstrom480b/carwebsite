...
@endfor
 ...
 <input type="textarea" placeholder="description" name="description"><br>
 </div>
 <div class="row">
...
<option value="Truck">Truck</option>
 ...
 <div class="row">
 <label>Duty </label>
 <input type="text" placeholder="duty" name='duty'><br>
  </div>
   <div class="row">
 <label>Interior</label>
 <input type="text" placeholder="carmodel" name="interior"><br>
 </div>
</div>
<div class="inner">
 <div class="row">
 ...
 <input type="checkbox" name="electricmirrors" value="electricmirrors">
 </div>
 <div class="row">
 <label>Traction Control</label>
 <input type="checkbox" name="tractioncontrol" value="tractioncontrol">
 </div>
 <div class="row">
 <label>Air Conditioning</label>
 <input type="checkbox" name="airconditioning" value="airconditioning">
 </div>
 <div class="row">
 <label>Power Steering</label>
 <input type="checkbox" name="powersteering" value="powersteering">
 </div>
 <div class="row">
 <label>AM/FM Radio</label>
 <input type="checkbox" placeholder="amfmradio" name="amfmradio" value="amfmradio"><br>
 </div>
 <div class="row">
 <label>Front Fog Lamps</label>
 <input type="checkbox" name="frontfoglamps" value="frontfoglamps">
 </div>
 <div class="row">
 <label>Electric Windows</label>
 <input type="checkbox" name="electricwindows" value="electricwindows">
 </div>
 <div class="row">
 <label>Alloy Wheels</label>
 <input type="checkbox" name="alloywheels" value="alloywheels">
 </div>
 <div class="row">
 <label>Fog Lights</label>
 <input type="checkbox" name="foglights" value="airbag">
 </div>
 <div class="row">
 <label>Thumb startignition</label>
 <input type="checkbox" name="thumbstart" value="airbag">
 </div>
 <div class="row">
