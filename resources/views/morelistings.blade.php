...
<div class="row"">
 <div class="col-lg-5""> 
<img src="/cover/{{$post->cover}}" class="img-responsiveness" style="background-color:#cecece; height:400px;width: 400px;"> 
<ul>
  <li>{{$post->carmake}}</li>
  <li>{{$post->carmodel}}</li>
  ...
  <li>{{$post->location}}</li>
    ...
    <h1 style="margin-top:10px;">Other Features</h1>
<div class="flex">
<li>{{$post->carmake}}</li>
  <li>{{$post->carmodel}}</li>
  <li>{{$post->yearofmanufacture}}</li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
   @foreach ($post->images as $img)
     ...
     <div class="item {{$img['id']==1?'active':' '}}">
    <img src="/images/{{$img->image}}" class="w-100 d-block">
        </div>
            @endforeach
      </div>
